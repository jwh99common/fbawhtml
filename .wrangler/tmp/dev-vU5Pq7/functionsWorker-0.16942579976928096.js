...
// .wrangler/tmp/pages-NOxYEX/functionsWorker-0.16942579976928096.mjs
...
async function onRequest(context) {
  ...
  const cached_time = await env.CACHE.read("someCacheKey", async (key) => {
    d1 = /* @__PURE__ */ new Date();
    d2 = new Date(d1.getTime() + 6e4);
    console.log(d1);
    console.log(d2);
...
// .wrangler/tmp/bundle-RERcOv/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RERcOv/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.16942579976928096.js.map
